...
import "./MonkToken.sol";

contract MonkTokenPreSale {
    MonkToken public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 10000000;
    uint constant public minSaleAmount = 500000000;

    function MonkTokenPreSale(
        MonkToken _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = MonkToken(_token);
